...
# Script to build Debug APK WITHOUT the embedded speech model (~22MB)
...
echo "=================================================="
echo "Building Debug APK WITHOUT Embedded Speech Model"
echo "=================================================="
...
./gradlew assembleDebug -PembedModel=false

OUTPUT_DIR="app/build/outputs/apk/debug"
SRC_APK="${OUTPUT_DIR}/app-debug.apk"
DEST_APK="${OUTPUT_DIR}/app-debug-no-model.apk"
